...
export type RentalRequest =
  Database['public']['Tables']['rental_requests']['Row'];
export type RentalRequestInsert =
  Database['public']['Tables']['rental_requests']['Insert'];
export type RentalRequestUpdate =
  Database['public']['Tables']['rental_requests']['Update'];
