...
exports.AuthController = exports.ForgotPasswordDto = exports.ChangePasswordDto = void 0;
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid password' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Reset email sent successfully' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
